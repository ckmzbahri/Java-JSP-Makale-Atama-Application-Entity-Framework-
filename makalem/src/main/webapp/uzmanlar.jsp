...
<div class="w3-row-padding" style="margin:0 -16px">
        ...
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
            <h2>UZMANLAR</h2>
                <form  action="uzmanekle.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5" style="width: 200px ">UZMAN EKLE</button>
       </div>
 </form>
  ...
  <tr>
     <td><%=rs.getString("ad") %></td>
      <td><%=rs.getString("soyad") %></td>
       ...
       <td><a href='uzmansil.jsp?id=<%=rs.getInt("id")%>'>Sil<span class="glyphicon glyphicon-edit" style="font-size:24px; color:green;"></span></a></td>
        <td><a href='uzmanguncelle.jsp?id=<%=rs.getInt("id")%>'>Güncelle<span class="glyphicon glyphicon-edit" style="font-size:24px; color:green;"></span></a></td>
