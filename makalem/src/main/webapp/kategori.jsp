...
<div class="w3-row-padding" style="margin:0 -16px">
        ...
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
            <h2>UZMANLIK ALANLARI</h2>
                <form  action="kategoriekle.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5" style="width: 200px ">ALAN EKLE</button>
       </div>
 </form>
 ...
 <form class="modal-content animate" action="geziguncelleme.jsp" method="post">
  ...
  <tr>
       ...
       <td><a href='kategorisil.jsp?id=<%=rs.getInt("id")%>'>Sil<span class="glyphicon glyphicon-edit" style="font-size:24px; color:green;"></span></a></td>
        <td><a href='kategoriguncelle.jsp?id=<%=rs.getInt("id")%>'>Güncelle<span class="glyphicon glyphicon-edit" style="font-size:24px; color:green;"></span></a></td>
