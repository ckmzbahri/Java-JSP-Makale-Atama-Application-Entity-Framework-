...
<meta charset="utf-9">
    <form class="modal-content animate" action="makaleatama.jsp" method="post">
    <jsp:useBean id="data" class="makale.baglanti"></jsp:useBean>
...
data.idaldim(veri);
 if (sonuc=true)
 {
    ...
    while(r.next()){ %>
           ...
           <br>
           <h3><%=r.getString("baslik") %></h3>
             <br><br>
            <label for="uname"><b>İÇERİK</b></label>
           <br>
           <h3><%=r.getString("icerik") %></h3>
                      <br><br>
           <label for="uname"><b>ALAN</b></label>
           <br>
           <h3><%=r.getString("tur") %></h3>
 ...
 <input type="text" name="id" id="id" value="<%=r.getString("id") %>" style="display:none;">
  <input type="text" name="tur" id="tur" value="<%=r.getString("tur") %>" style="display:none;">
           <br>
