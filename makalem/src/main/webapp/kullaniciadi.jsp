...
<form class="modal-content animate" action="yazarkayitview.jsp" method="post">
      <div class="w3-half w3-margin-bottom">
        ...
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
           ...
           <br><br>
           <input type="text" placeholder="Mail" name="mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"title="E-mail formatında giriniz." required>>
           <br><br>
           ...
           <label for="uname"><b>ŞİFRE</b></label>
           <br><br>
           <input type="password" placeholder="Şifre" name="sifre" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,}" title=" Şifre en az 5 karakter,en az bir büyük,en az bir küçük harf" required>  
           <br><br>
           <li class="w3-light-grey w3-padding-24">
              <div class="container" style="background-color:#f1f1f1">
              <br>
...
<script>
  alert("BU KULLANICI ADI DAHA ÖNCE BAŞKASI TARAFINDAN KULLANILMIŞ");
</script>
</body>
</html>